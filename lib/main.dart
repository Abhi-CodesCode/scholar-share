...
import 'package:scholar_shore/pages/test_page.dart';
...
void main() async{
  ...
  Get.put(ModPageController());
  var home;
  await FirebaseAuth.instance
      .authStateChanges()
      .listen((User? user) {
    if (user == null) {
      // convert this to login, after u gain good amt of users,
      //  it's a good practice to make them login tho with a single
      //click
      home = SignUpPage();
    }
    else if(user.email=='mod@gmail.com' || user.email=='mod@scholarshare.com'){
      home = ModPage();
    }
    else  {
      home = MyApp();
